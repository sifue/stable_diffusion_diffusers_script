...
# prompt = "Pablo Picasso style painting"
# prompt = "Claude Monet style painting"
# prompt = "Shinkai Makoto style painting"
# prompt = "Studio Ghibli style painting"

with autocast(DEVICE):
    with open('./results/init.jpg', "rb") as fh:
